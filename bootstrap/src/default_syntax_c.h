static constexpr const char* DEFAULT_SYNTAX_C =
    ...
    "\n"
    "// TODO: generate explicit values in goto/label mode\n"
    "code:enum =\n"
    "    \"enum \" type \" {\" nl indent\n"
    "        [elem{0:-2}: topindent elem (!.code_model.goto_label ? \" = \" init) \",\" nl]\n"
    "        [elem{-1}:   topindent elem (!.code_model.goto_label ? \" = \" init) nl]\n"
    "    dedent \"};\" nl;\n"
    "\n"
    "code:enum_elem = name;\n"
    "\n"
